    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">RSBSA INVENTORY <sup>2</sup></div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="tables.php"><b>Capital Outplay</b></a>
                        <a class="collapse-item" href="tables.php"><b>Semi Expendable</b></a>
                    </div>
                </div>
            </li>
            <!-- Nav Item - Pages Collapse ICT Equipment -->
            <li class="nav-item">
            ...
            <!-- Nav Item - Pages Collapse ICT Office Supply -->
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseTwo2"
                    aria-expanded="true" aria-controls="collapseTwo2">
                    <i class=""></i>
                    <span>ICT Office Supply</span>
                </a>
            ...
            <!-- Nav Item - Pages Collapse Other Supply -->
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseUtilities"
                    aria-expanded="true" aria-controls="collapseUtilities">
                    <i class=""></i>
                    <span>Other Supply</span>
                </a>
            ...
            <div class="col-lg-12">
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h2 class="m-0 font-weight-bold text-success">Add Supply</h2>
                  ...
                  <form class="form-group" method="post" action="action.php" Enctype="multipart/form-data">
                    ...
                    <div class="row">
                      ...
                      <div class="col-12 pl-5 pr-5 mb-3 d-flex justify-content-center">
                        <button class="btn btn-primary" type="submit" value="Submit" name="AddNewItem">Add New Item</button>
                      </div>
                    </div>
                  </form>
                </div>
